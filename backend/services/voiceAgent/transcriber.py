...
class Transcriber:
    ...
    def transcribe(
        ...
        try:
            ...
            # Use audio_path (original file) not effective_path — for video inputs
            # effective_path is None until _local_path() is first called.
            if self._audio_data is None:
                self._load_audio_cached(audio_path)
