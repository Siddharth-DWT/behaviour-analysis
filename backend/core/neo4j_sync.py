# backend/core/neo4j_sync.py
"""
NEXUS Backend — Neo4j Sync (Phase 3A: Single-Session Knowledge Graph)
...
Copied verbatim from services/api_gateway/neo4j_sync.py.
...
async def sync_speaker_registry_to_neo4j(pool, registry_id: str) -> bool:
    ...
    Called by AnalysisPipeline.run() immediately after sync_session so all
