# services/language_agent/entity_extractor.py
"""
...
{{
  ...
  "objections": [
    {{"text": "exact quote from transcript", "speaker": "Speaker_X", "timestamp_ms": number, "resolved": true|false, "resolved_at_ms": number}}
  ],
  "commitments": [
